...
$deactivates=0;
$total_pages_sql = "SELECT COUNT(*) FROM tblperson where (Category=:cat and City=:loc and DEACTIVES='$deactivates')";
$query= $dbh -> prepare($total_pages_sql);
...
$sql="SELECT * from  tblperson where (Category=:cat and City=:loc and DEACTIVES='$deactivates') LIMIT $offset, $no_of_records_per_page";
...
{               ?>
													<div class="item col-md-4 col-sm-6 col-xs-12">
														<!-- .ITEM -->
														<div class="listing-item clearfix" style="width:270px; background:transparent;">
	
															<div class="figure" style="background:transparent;">
																<img src="admin/images/<?php echo $row->Picture;?>" alt="listing item" height="220" width="270" style="border-radius:20px; background:transparent;"/>
																
															</div>
															<div class="listing-content clearfix" style="background: #ffffff; border-radius:10px;">
														...
														<div class="listing-border-bottom bgyallow-1" style="width:270px;"></div>
													</div>
	<?php $cnt=$cnt+1;}} ?>
												</div>
											</div>
