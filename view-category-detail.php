...
$deactivates=0;
$total_pages_sql = "SELECT COUNT(*) FROM tblperson where (Category=:vid and DEACTIVES='$deactivates')";
...
$sql="SELECT * from  tblperson where (Category=:vid and DEACTIVES='$deactivates') LIMIT $offset, $no_of_records_per_page";
