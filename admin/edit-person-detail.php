            ...
            <div class="card card-primary">
              ...
              <form role="form" method="post" enctype="multipart/form-data">
                <?php
                  $deactivates=0;
                   $eid=$_GET['editid'];
$sql="SELECT * from tblperson where ID=$eid and DEACTIVES='$deactivates'";
$query = $dbh -> prepare($sql);
$query->execute();
...
<option value="<?php echo htmlentities($row1->Category);?>"><?php echo htmlentities($row1->Category);?></option>
 <?php } ?> 
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="email" name="email" value="<?php echo htmlentities($row->Email);?>" required="true" readonly="true">
                  </div>
                  <div class="form-group">
              ...
              <?php $cnt=$cnt+1;}}else{
                echo "<script type='text/javascript'> document.location ='manage-person.php'; </script>";
              } ?> 
